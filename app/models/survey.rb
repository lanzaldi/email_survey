class Survey < ActiveRecord::Base
  ...
  belongs_to :survey_user, :inverse_of => :surveys
  validates_presence_of :marital_status, :employment, :pil1, :pil2, :pil3, :pil4, :pil5, :pil6, :pil7, :pil8, :pil9, :pil10, :pil11, :pil12, :pil13, :pil14, :pil15, :pil16, :pil17, :pil18, :pil19, :pil20
  
  validates_presence_of :disability, :last_exacerbation, :new_symptoms, :if => Proc.new { |s| s.survey_user.person_type == "ms" }
 
	def self.PILqs
		[{stem: "I am usually", l: "completely bored", r: 		"exuberantly enthusiastic" },
